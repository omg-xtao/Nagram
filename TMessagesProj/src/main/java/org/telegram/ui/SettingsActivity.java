...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate, MainTabsActivity.TabFragmentDelegate, FactorAnimator.Target {
    ...
    public View createView(Context context) {
        ...
        searchItem = menu.addItem(0, R.drawable.ic_ab_search, resourceProvider).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
        ...
        listView.setOverScrollListener(() -> listView.postOnAnimation(this::blur3_InvalidateBlur));
...
//                top = Math.max(actionBar.getHeight(), top);
        ...
        topView.addView(avatarContainer, LayoutHelper.createFrame(120, 120, Gravity.CENTER_HORIZONTAL | Gravity.TOP, 0, 23, 0, 0));
        ...
        topView.addView(titleView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL | Gravity.TOP, 0, 138.333f, 0, 0));
        ...
        topView.addView(subtitleView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL | Gravity.TOP, 0, 168, 0, 0));
...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(UItem.asCustom(topView, 200));
        ...
        items.add(SettingCell.Factory.of(100, 0xFF1BA4ED, 0xFF1488E1, R.drawable.msg_settings, getString(R.string.NekoSettings)));
        items.add(UItem.asShadow(null));
...
//        items.add(SettingCell.Factory.of(14, 0, "Wallet"));
        ...
        items.add(UItem.asCustom(versionView));
    }
...
//            ignoreClearViews = true;
//            if (LaunchActivity.instance != null) {
//                LaunchActivity.instance.switchToAccount(account, false);
//            }
//            ignoreClearViews = false;
...
//            listView.adapter.update(true);
    ...
    public static class AccountCell extends LinearLayout {
        ...
        public static class Factory extends UItem.UItemFactory<AccountCell> {
            ...
            @Override
            public AccountCell createView(Context context, int currentAccount, int classGuid, Theme.ResourcesProvider resourcesProvider) {
    ...
    public static class SettingCell extends LinearLayout {
        ...
        public static class Factory extends UItem.UItemFactory<SettingCell> {
            ...
            @Override
            public SettingCell createView(Context context, int currentAccount, int classGuid, Theme.ResourcesProvider resourcesProvider) {
    ...
    public static class SuggestionCell extends LinearLayout {
        ...
        public static class Factory extends UItem.UItemFactory<SuggestionCell> {
            ...
            @Override
            public SuggestionCell createView(Context context, int currentAccount, int classGuid, Theme.ResourcesProvider resourcesProvider) {
    ...
    public void openDebugMenu() {
        ...
        items = new CharSequence[]{
                ...
                BuildVars.DEBUG_PRIVATE_VERSION ? (SharedConfig.frameMetricsEnabled ? "hide frame metrics" : "show frame metrics") : null
        };
